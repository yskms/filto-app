...
- 個人開発プロジェクト
- **現在 App Store / Google Play にて公開中（v1.5.1）** — [App Store](https://apps.apple.com/jp/app/filto/id6763070121) ／ [Google Play](https://play.google.com/store/apps/details?id=com.yskms.filto)
