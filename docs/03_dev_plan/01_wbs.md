...
### v1.5.1（記事保持期間の見直しと手動削除の廃止 / iOS審査通過 2026-09-07・Android未着手）
...
### v1.5.2（ホーム表示性能・更新結果表示・スプラッシュ改善 / 2026-09-13準備）
...
- [ ] iOS/Android productionビルド
- [ ] TestFlight / Play内部テストで主要機能を確認
- [ ] App Store / Google Playへ提出
