...
- [x] 空/初期状態対応（GlobalAllowKeywords画面）
...
- **達成**:
  ...
  - Settings / AddFilter / AddFeed / Data Management / GlobalAllowKeywords / About の英語表示を反映
  - 主要な空状態・プレースホルダ・操作文言の翻訳キー化を実施
...
- **改善**: 
  ...
  - 色の指定は最初からuseThemeColorを使う習慣をつける
