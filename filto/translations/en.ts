...
export const en = {
  ...
  home: {
    ...
    tutFeedDesc: 'Switch or multi-select the feeds you read.',
    ...
    tutStarViewTitle: 'View favorites',
    tutStarViewDesc: 'Tap the star icon to show only your favorited articles.',
    tutFilterTitle: 'Review hidden articles',
    tutFilterDesc: 'How many articles your keywords hid. Tap to show them in the list.',
    tutFiltersTabTitle: 'Manage filters',
    tutFiltersTabDesc: 'Manage your filters (hidden keywords) from here.',
  ...
  filters: {
    title: 'Filters',
    tutAddTitle: 'Add a filter',
    tutAddDesc: 'Tap here to add a keyword you want to block.',
