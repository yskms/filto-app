...
export const en = {
  ...
  onboarding: {
    ...
    step3Title: 'How to use',
    step3Subtitle: 'Take a quick look while we get things ready',
    preparing: 'Preparing…',
    howtoFeedsTitle: 'Pick feeds to read',
    howtoFeedsDesc: 'Tap the feed name on top to switch, multi-select, or sort',
    howtoFilterTitle: 'Hide topics you don\'t want',
    howtoFilterDesc: 'Filter by keyword. Tap the filtered bar to review them',
    howtoStarTitle: 'Star articles you like',
    howtoStarDesc: 'Long-press an article to add it to favorites',
    howtoRefreshTitle: 'Get the latest',
    howtoRefreshDesc: 'Pull to refresh; auto-syncs on launch',
    howtoManageTitle: 'Add or edit feeds',
    howtoManageDesc: 'Manage your feeds anytime on the Feeds tab',
    next: 'Next',
    back: 'Back',
    start: 'Get Started',
    skip: 'Skip',
