...
export const en = {
  ...
  home: {
    ...
    tutFeedDesc: 'Switch the displayed feed or *select multiple feeds*.',
    tutRefreshDesc: 'This is the *refresh button*. You can also pull the list down to refresh.',
  ...
  filters: {
    ...
    tutListDesc: 'Tap a registered block filter to *edit*, *swipe to delete*.',
    sampleKeyword1: 'Spoilers',
    sampleKeyword2: 'Ads',
    sampleKeyword3: 'Horoscope',
    tutBlockDesc: '*Hide* articles that contain this text.',
    tutAllowDesc: 'Even when an article would be hidden, it *stays visible* if it contains this text.',
    tutTargetDesc: 'Choose the *range to search*.',
  ...
  feeds: {
    ...
    tutListDesc: 'Tap a registered RSS feed to *edit*, *swipe to delete*.',
