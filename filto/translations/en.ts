...
export const en = {
  ...
  dataManagement: {
    ...
    backgroundFetch: 'Update automatically',
    backgroundFetchHint: 'When on, Filto fetches new articles in the background while the app is closed, so they are ready the next time you open it. The timing and frequency depend on your device.',
