...
export const en = {
  ...
  dataManagement: {
    ...
    backupHint: 'Export or restore your feeds, filters, global allow keywords, and articles as a JSON file. When off, only favorited articles are included. Display settings are not included.',
