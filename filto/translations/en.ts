...
export const en = {
  ...
  dataManagement: {
    ...
    backgroundFetch: 'Update even when the app is closed',
    backgroundFetchHint: 'When on, Filto fetches RSS periodically in the background so articles are ready next time you open the app. The OS decides when it runs, so timing is not guaranteed (especially on iOS).',
