...
export const en = {
  ...
  home: {
    ...
    hideThisSite: 'Hide this site',
    siteHiddenToast: 'Hid "{{name}}" from Home',
    suggestHideSiteTitle: 'A site you keep hiding',
    suggestHideSiteBody: 'You keep hiding articles from "{{name}}". Hide this site from Home? (You can undo anytime in feed management.)',
    suggestHideSiteConfirm: 'Hide this site',
    suggestHideSiteLater: 'Not now',
    show: 'Show',
    hide: 'Hide',
  ...
  feeds: {
    ...
    feedFound: 'Found a feed',
    selectFeedTitle: 'Select a feed',
    selectFeedDescription: 'Multiple feeds were found on this page',
    commentFeedTag: 'Comments',
    ...
    signalOften: 'Read often',
    signalRarely: 'Rarely read',
    signalNever: 'Never read',
  ...
  dataManagement: {
    ...
    backupRestoreKeywordsSkipped: '{{count}} allow keyword(s) exceed the free version limit and were not added.',
    backupRestoreFiltersSkipped: '{{count}} filter(s) exceed the free version limit and were not added.',
