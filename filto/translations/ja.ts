...
export const ja = {
    ...
    home: {
      ...
      tutFeedDesc: 'ここをタップ。読むフィードの切替・複数選択ができます。',
      tutRefreshTitle: '最新に更新',
      tutRefreshDesc: 'タップで更新。一覧を下に引っ張っても更新できます。',
      tutStarTitle: 'お気に入りに追加',
      tutStarDesc: '記事を長押しするとスター（お気に入り）に登録できます。',
      tutFilterTitle: '非表示の記事を確認',
      tutFilterDesc: 'キーワードで隠した記事の件数。タップすると内容を確認できます。',
      tutTabsTitle: 'フィルタとフィード管理',
      tutTabsDesc: '下のタブから、フィルタの追加や、フィードの登録・削除ができます。',
