...
export const ja = {
    ...
    home: {
      ...
      tutFeedTitle: '表示フィードを選ぶ',
      tutFeedDesc: '読むフィードの切替・複数選択ができます。',
      tutRefreshTitle: '最新に更新',
      tutRefreshDesc: 'タップで更新。一覧を下に引っ張っても更新できます。',
      tutStarTitle: 'お気に入りに追加',
      tutStarDesc: '記事を長押しするとお気に入りに登録できます。',
      tutStarViewTitle: 'お気に入りを表示',
      tutStarViewDesc: 'スターのアイコンをタップすると、お気に入りした記事だけを表示できます。',
      tutFilterTitle: '非表示の記事を確認',
      tutFilterDesc: 'キーワードで隠した記事の件数。タップで一覧に表示できます。',
      tutFiltersTabTitle: 'フィルタ管理',
      tutFiltersTabDesc: 'ここからフィルタ（非表示にするキーワード）を管理できます。',
    ...
    filters: {
      title: 'フィルタ',
      tutAddTitle: 'フィルタを追加',
      tutAddDesc: 'ここからブロックしたいキーワードを追加できます。',
