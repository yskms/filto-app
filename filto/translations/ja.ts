...
export const ja = {
    ...
    home: {
      ...
      tutFeedDesc: '表示するフィードの切替・複数選択ができます。',
      tutRefreshDesc: '更新ボタンです。一覧を下に引っ張っても更新できます。',
      tutStarDesc: '記事を長押しすると、お気に入りに登録できます。',
      tutStarViewDesc: 'お気に入りした記事だけを表示できます。',
      tutFilterDesc: '非表示にした記事を、タップで一覧に表示できます。',
      tutFiltersTabDesc: 'ここからブロックフィルタを管理できます。',
    ...
    filters: {
      title: 'フィルタ',
      tutAddDesc: 'ここからブロックフィルタを追加登録できます。',
      tutListDesc: '登録済みのブロックフィルタは、タップで編集、スワイプで削除可能です。',
      sampleKeyword1: 'ネタバレ',
      sampleKeyword2: '広告',
      sampleKeyword3: '占い',
      tutBlockDesc: 'この文字を含む記事を非表示にします。',
      tutAllowDesc: '非表示対象であっても、ここの文字が含まれていれば表示します。',
      tutTargetDesc: '検索対象の範囲を選べます。',
      addFilter: 'フィルタを追加',
      editFilter: 'フィルタを編集',
      deleteMode: '削除モード',
      normalMode: '通常モード',
    ...
    feeds: {
      title: 'フィード',
      tutTabDesc: 'ここからRSSフィードを管理できます。',
      tutListDesc: '登録済みのRSSフィードは、タップで編集、スワイプで削除可能です。',
      tutAddDesc: 'ここからRSSフィードを追加登録できます。',
      tutUrlDesc: '追加したいRSSフィードのURLを入力します。',
      tutFetchDesc: 'URLを入力したらここを押して、フィード情報を取得します。成功すると下の「追加」ボタンが押せるようになります。',
      tutNameDesc: 'RSSフィードの表示名を入力します。',
      addFeed: 'フィードを追加',
      editFeed: 'フィードを編集',
      deleteMode: '削除モード',
      normalMode: '通常モード',
