...
export const ja = {
    ...
    onboarding: {
      ...
      step3Title: '基本の使い方',
      step3Subtitle: '準備が終わるまでに、ざっと目を通してください',
      preparing: '準備中…',
      howtoFeedsTitle: 'フィードを選んで読む',
      howtoFeedsDesc: '上部のフィード名をタップで切替・複数選択・並べ替えができます',
      howtoFilterTitle: '見たくない話題を非表示',
      howtoFilterDesc: 'キーワードでフィルタ。非表示バーをタップで中身を確認できます',
      howtoStarTitle: '気になる記事にスター',
      howtoStarDesc: '記事を長押しでお気に入りに追加できます',
      howtoRefreshTitle: '最新に更新',
      howtoRefreshDesc: '引っ張って更新、起動時は自動で取得します',
      howtoManageTitle: 'フィードを追加・編集',
      howtoManageDesc: 'フィード画面でいつでも管理できます',
      next: '次へ',
      back: '戻る',
      start: 'はじめる',
      skip: 'スキップ',
