...
const CAT_ORDER = {
  ja: ['news', 'tech', 'business', 'science', 'dev', 'game', 'anime', 'entertainment', 'sports', 'fashion', 'lifestyle', 'food', 'auto', 'travel'],
  en: ['world', 'tech', 'business', 'science', 'game', 'entertainment', 'sports', 'design', 'fashion', 'food', 'auto', 'travel', 'culture'],
};
const LABELS = {
  ja: { news: 'ニュース', tech: 'テクノロジー', business: 'ビジネス・マネー', science: 'サイエンス・健康', dev: '開発・プログラミング', game: 'ゲーム', anime: 'アニメ・マンガ', entertainment: 'エンタメ・音楽', sports: 'スポーツ', fashion: 'ファッション・美容', lifestyle: 'ライフスタイル', food: 'グルメ・料理', auto: '自動車', travel: '旅行' },
